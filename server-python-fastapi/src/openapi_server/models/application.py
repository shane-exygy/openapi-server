...
from openapi_server.models.application_application import ApplicationApplication
try:
...
class Application(BaseModel):
    ...
    application: Optional[ApplicationApplication] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "application": ApplicationApplication.from_dict(obj.get("application")) if obj.get("application") is not None else None,
