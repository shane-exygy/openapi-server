...
from openapi_server.models.result_payload_inner_application import ResultPayloadInnerApplication
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class ResultPayloadInner(BaseModel):
    """
    ResultPayloadInner
    """ # noqa: E501
    applicant_id: Optional[StrictInt] = None
    application: Optional[ResultPayloadInnerApplication] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ResultPayloadInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ResultPayloadInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "application": ResultPayloadInnerApplication.from_dict(obj.get("application")) if obj.get("application") is not None else None,
