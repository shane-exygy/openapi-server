...
from openapi_server.models.result_payload_application import ResultPayloadApplication
try:
...
class ResultPayload(BaseModel):
    ...
    application: Optional[ResultPayloadApplication] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ResultPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ResultPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "application": ResultPayloadApplication.from_dict(obj.get("application")) if obj.get("application") is not None else None,
